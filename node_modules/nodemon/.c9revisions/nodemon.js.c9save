...
{"contributors":[],"silentsave":false,"ts":1364597471809,"patch":[[{"diffs":[[0,"now();\n\n"],[1,"  var nodeMajor = parseInt((process.versions.node.split('.') || [,,])[1] || 0)\n\n  if (nodeMajor >= 8) {\n  "],[0,"  child "]],"start1":5680,"start2":5680,"length1":16,"length2":122},{"diffs":[[0,"args, {\n    "],[1,"  "],[0,"stdio: ['pip"]],"start1":5840,"start2":5840,"length1":24,"length2":26},{"diffs":[[0,"stderr]\n"],[1,"  "],[0,"  });\n  "],[1,"} else {\n    child = spawn(program.options.exec, program.args);\n    child.stdout.on('data', function (data) {\n      process.stdout.write(data);\n    });\n    child.stderr.on('data', function (data) {\n      process.stderr.write(data);\n    });\n  }\n"],[0,"\n  child"]],"start1":5894,"start2":5894,"length1":24,"length2":270},{"diffs":[[0,"killNode();\n"],[-1,"            "],[0,"\n"],[1,""],[0,"          },"]],"start1":11008,"start2":11008,"length1":37,"length2":25},{"diffs":[[0,"();\n"],[-1,"            "],[0,"\n"],[1,""],[0,"    "]],"start1":11930,"start2":11930,"length1":21,"length2":9},{"diffs":[[0,"  }\n"],[-1,"    "],[0,"\n"],[1,""],[0,"    "]],"start1":19547,"start2":19547,"length1":13,"length2":9},{"diffs":[[0,").join('"],[1,"$"],[0,"|');\n  }"]],"start1":20398,"start2":20398,"length1":16,"length2":17},{"diffs":[[0,"    "],[-1,"child && child.kill('SIGINT');\n    cleanup();\n    process."],[1,"var exitTimeout = null,\n        exit = function () {\n          exit = function () {};\n          cleanup();\n          process.exit(0);\n        };\n\n    if (child && !isWindows) {\n      child.removeAllListeners('exit');\n      child.on('exit', exit);\n      child.kill('SIGINT');\n      setTimeout(exit, 10 * 1000); // give up waiting for the kids after 10 seconds\n    } else {\n      "],[0,"exit("],[-1,"0"],[0,");\n"],[1,"    }\n"],[0,"  })"]],"start1":23306,"start2":23306,"length1":75,"length2":400},{"diffs":[[0,"eRule('^((?!\\.js"],[1,"$"],[0,"|\\.coffee$).)*$'"]],"start1":24271,"start2":24271,"length1":32,"length2":33},{"diffs":[[0,"       } else {\n"],[-1,""],[0,"            addI"]],"start1":25704,"start2":25704,"length1":32,"length2":32},{"diffs":[[0,"((?!\\.js"],[1,"$"],[0,"|\\.coffe"]],"start1":25748,"start2":25748,"length1":16,"length2":17}]],"length":25910,"saved":false}
